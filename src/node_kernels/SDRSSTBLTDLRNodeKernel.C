...
SDRSSTBLTDLRNodeKernel::SDRSSTBLTDLRNodeKernel(
  const stk::mesh::MetaData& meta)
  : NGPNodeKernel<SDRSSTBLTDLRNodeKernel>(),
...
void
SDRSSTBLTDLRNodeKernel::setup(Realm& realm)
{
...
KOKKOS_FUNCTION
void
SDRSSTBLTDLRNodeKernel::execute(
