...
#ifndef AFTGammaTildaEquationSystem_h
#define AFTGammaTildaEquationSystem_h
...
class AFTGammaTildaEquationSystem : public EquationSystem
{
public:
  AFTGammaTildaEquationSystem(EquationSystems& equationSystems);
  virtual ~AFTGammaTildaEquationSystem();
  ...
  ScalarFieldType* gammaTilda_;
  VectorFieldType* dgtdx_;
  ScalarFieldType* gammaTmp_;
