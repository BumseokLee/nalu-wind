...
#ifndef SDRSSTBLTDLRNODEKERNEL_H
#define SDRSSTBLTDLRNODEKERNEL_H
...
class SDRSSTBLTDLRNodeKernel : public NGPNodeKernel<SDRSSTBLTDLRNodeKernel>
{
public:
  SDRSSTBLTDLRNodeKernel(const stk::mesh::MetaData&);

  SDRSSTBLTDLRNodeKernel() = delete;

  KOKKOS_DEFAULTED_FUNCTION
  virtual ~SDRSSTBLTDLRNodeKernel() = default;
...
#endif /* SDRSSTBLTDLRNODEKERNEL_H */
