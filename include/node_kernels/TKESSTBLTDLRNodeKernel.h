...
#ifndef TKESSTBLTDLRNODEKERNEL_H
#define TKESSTBLTDLRNODEKERNEL_H
...
class TKESSTBLTDLRNodeKernel : public NGPNodeKernel<TKESSTBLTDLRNodeKernel>
{
public:
  TKESSTBLTDLRNodeKernel(const stk::mesh::MetaData&);

  TKESSTBLTDLRNodeKernel() = delete;

  KOKKOS_DEFAULTED_FUNCTION
  virtual ~TKESSTBLTDLRNodeKernel() = default;
...
#endif /* TKESSTBLTDLRNODEKERNEL_H */
